...
public class MyStocksActivity extends AppCompatActivity
        implements LoaderManager.LoaderCallbacks<Cursor>, QuoteCursorAdapter.AdapterOnClickHandler {
    ...
    @Override
    public void onClick(QuoteCursorAdapter.ViewHolder vh) {
        Uri uri = QuoteProvider.History.withSymbol(vh.symbol.getText().toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter.addAction(StockTaskService.BROADCAST_ACTION);
