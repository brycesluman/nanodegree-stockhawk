...
public class Utils {
    ...
    public static ContentProviderOperation buildHistoryBatchOperation(JSONObject jsonObject) {
        ...
        try {
            ...
            builder.withValue(HistoricalDataColumns.CLOSE, jsonObject.getString("Close"));
            builder.withValue(HistoricalDataColumns.DATE_STRING, jsonObject.getString("Date"));
            builder.withValue(HistoricalDataColumns.DATE, milliseconds);
            builder.withValue(HistoricalDataColumns.HIGH, jsonObject.getString("High"));
            builder.withValue(HistoricalDataColumns.LOW, jsonObject.getString("Low"));
            builder.withValue(HistoricalDataColumns.OPEN, jsonObject.getString("Open"));
            builder.withValue(HistoricalDataColumns.VOLUME, jsonObject.getString("Volume"));
